...
public class ScienceTeacher extends StaffFeatures implements Activities {
	
	

	public ScienceTeacher(String name, String phone, String address, String role, String year) {
